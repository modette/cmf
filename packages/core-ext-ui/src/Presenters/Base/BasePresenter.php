...
namespace Modette\UI\Presenters\Base;
...
use Modette\UI\Controls\Document\DocumentControl;
use Modette\UI\Controls\Document\DocumentFactory;
use Modette\UI\FakeTranslator;
use Modette\UI\Presenters\InternalError\InternalErrorPresenter;
