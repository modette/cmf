...
namespace Modette\Admin\Presenters\Error;

use Modette\Admin\Presenters\Admin\Admin;
...
class Error extends Admin
{
	...
	public function renderDefault(?Throwable $exception = null): void
	{
		...
		//todo - translate
		//$this->translator->translate("$view.title", null, [], 'modette.admin.presenters.error')
